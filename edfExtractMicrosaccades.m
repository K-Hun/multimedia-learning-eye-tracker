function microsaccades = edfExtractMicrosaccades(Trials, VelocityBraketMS, VelocityThreshold, MinimalDurationMS, MinimalSeparationMS)
...
for iTrial= 1:length(1)
  ...
  Samples.gx(isnan(Samples.gx))=0;
  Samples.gy(isnan(Samples.gy))=0;
  Samples.gx = Samples.gx';
  Samples.gy = Samples.gy';
  Samples.gx(2, :) = Samples.gx(1, :);
  Samples.gy(2, :) = Samples.gy(1, :);
